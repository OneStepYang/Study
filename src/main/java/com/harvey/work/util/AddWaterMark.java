...
public class AddWaterMark {
    ...
    public InputStream addWaterMarkSongs(InputStream is, String fileType, String[] songs, boolean orderFlag) {
        ...
        if (orderFlag) {
            ...
            for (int i = 0; i < j; ++i) {
                ...
                if (result)
                    length = (int) Math.ceil(length / 2.00D);
        ...
        try {
            ...
            for (int i = 0; i < ll; ++i) {
                ...
                y = (int) (height * 0.29D + textHeight * 1.600 * (i + 1));
    ...
    public InputStream addWaterMarkSongsTwo(InputStream is, String fileType, String[] songs, boolean orderFlag) {
        String string;
        LinkedList two = new LinkedList();
        LinkedList three = new LinkedList();
        LinkedList four = new LinkedList();
        ...
        try {
            ...
            int textHeight = g.getFontMetrics().getHeight();
            for (int i = 0; i < ll; ++i) {
                x = (int) (width * 0.50D - (getWatermarkLength((String) songArr.get(i), g) / 2));
                y = (int) (height * 0.29D + textHeight * 1.600 * (i + 1));
                g.drawString((String) songArr.get(i), x, y);
            }
            g.dispose();
